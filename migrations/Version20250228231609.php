 ...
 */
final class Version20250228231609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact CHANGE content content LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact CHANGE content content VARCHAR(255) NOT NULL');
    }
}
