...
class __TwigTemplate_5f0b76c598c3744cba9cde7935f2c778 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["temoignages"]) || array_key_exists("temoignages", $context) ? $context["temoignages"] : (function () { throw new RuntimeError('Variable "temoignages" does not exist.', 15, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["temoignage"]) {
            // line 16
            yield "                    <div class=\"block-temoignage\">
                        <h3 class=\"temoignage-title\">";
            // line 17
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["temoignage"], "title", [], "any", false, false, false, 17), "html", null, true);
            yield "</h3>
                        <p class=\"message\">";
            // line 18
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["temoignage"], "content", [], "any", false, false, false, 18), "html", null, true);
            yield "</p>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                // line 21
                yield "                                ";
                if (($context["i"] <= CoreExtension::getAttribute($this->env, $this->source, $context["temoignage"], "rating", [], "any", false, false, false, 21))) {
                    // line 22
...
";
    ...
    {
        return array (  163 => 30,  155 => 27,  149 => 26,  145 => 24,  141 => 22,  138 => 21,  134 => 20,  129 => 18,  125 => 17,  122 => 16,  118 => 15,  113 => 12,  107 => 10,  105 => 9,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
