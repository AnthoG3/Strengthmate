...
class __TwigTemplate_6c5f06af0c06455d07780d94190f7b4e extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["temoignages"]) || array_key_exists("temoignages", $context) ? $context["temoignages"] : (function () { throw new RuntimeError('Variable "temoignages" does not exist.', 17, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["temoignage"]) {
            // line 18
            yield "                    <!-- From Uiverse.io by Yaya12085 -->
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                // line 25
                yield "                                        <svg fill=\"";
                yield ((($context["i"] <= $this->extensions['Twig\Extension\CoreExtension']->formatNumber(CoreExtension::getAttribute($this->env, $this->source, $context["temoignage"], "rating", [], "any", false, false, false, 25)))) ? ("currentColor") : ("none"));
                yield "\" viewBox=\"0 0 20 20\" xmlns=\"http://www.w3.org/2000/svg\">
            ...
            yield "                                </div>
                                <p class=\"name\">";
            // line 30
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["temoignage"], "title", [], "any", false, false, false, 30), "html", null, true);
            yield "</p>
                            </div>
                        </div>
                        <p class=\"message\">";
            // line 33
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["temoignage"], "content", [], "any", false, false, false, 33), "html", null, true);
            yield "</p>
                    </div>
                ";
        }
...
";
    ...
    {
        return array (  165 => 36,  156 => 33,  150 => 30,  147 => 29,  136 => 25,  132 => 24,  124 => 18,  120 => 17,  115 => 14,  109 => 12,  107 => 11,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
